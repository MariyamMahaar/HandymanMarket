...
<h2 >ARE YOU LOOKING FOR A PAINTER?</h2>
<section class= "my-5">
<div class="py-5">
</div>
...
$sql="SELECT ID, name, phoneNumber, email,gender,location,budget FROM signedup where Location='$check_location' and Budget='$check_budget' and Category='painter'";

$result = $conn -> query ($sql);
if($result -> num_rows > 0)
{
  echo "<h2 style='margin:  80px;'>Available Painters </h2>";
  ...
  echo "<br>";
  echo "<br>";
  echo "<h3>Paint service not found in your location/budget</h3>";
}
$conn-> close();
