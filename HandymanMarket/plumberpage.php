...
<h2 >ARE YOU LOOKING FOR A PLUMBER?</h2>
<section class= "my-5">
<div class="py-5">
</div>
...
$sql="SELECT name, phoneNumber, email,gender,location,budget FROM signedup where Location='$check_location' and Budget='$check_budget' and Category='plumber'";
...
if($result -> num_rows > 0)
{
  ...
  echo "<br>";
  echo "<br>";
  echo "<h3>Plumber service not found in your location/budget</h3>";
}
$conn-> close();
