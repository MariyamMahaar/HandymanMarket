...
<section class= "my-5">
<div class="py-5">
<h2 class="text-center text-white"> Login for a Customer </h2>
</div>

<div class="w-50 m-auto">
<form action="signupcustomerdbconnection.php" method="post">
...
<br>
<button type="submit" name="submit_btn" class="btn btn-light">Login</button>
